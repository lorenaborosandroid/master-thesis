...
class PatientRequestJsonAdapter(
  moshi: Moshi
) : JsonAdapter<PatientRequest>() {
  ...
  override fun toString(): String = buildString(36) {
      append("GeneratedJsonAdapter(").append("PatientRequest").append(')') }

  override fun fromJson(reader: JsonReader): PatientRequest {
  ...
  override fun toJson(writer: JsonWriter, value: PatientRequest?) {
    if (value == null) {
